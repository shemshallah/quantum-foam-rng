...
class QuantumFoamRNG_Free:
    ...
    def generate_crypto_key(self, verbose=True):
        ...
        randomness_score = sum(final_bits) / len(final_bits)
...
if __name__ == '__main__':
    ...
    print(f"   3. SHA-512 post-processing added")
    print(f"\n⚡ OPTIMIZATIONS:")
    print(f"   - Parallel circuit execution ({MAX_WORKERS} workers)")
    print(f"   - Expected time: 45-90s per key")
    print(f"{'='*80}\n")
